...
import com.notify.entity.Notes;
import com.notify.entity.UserDtls;
import com.notify.repository.NotesRepository;
...
public class UserController {
	...
	public String saveNotes(@ModelAttribute Notes notes, HttpSession session, Principal p) {
		...
		System.out.println("Session msg: " + session.getAttribute("msg"));
	...
	public String updateUser(@ModelAttribute UserDtls user, HttpSession session, Model m) {
        ...
        Optional<UserDtls> Olduser=userRepository.findById((long) user.getId());
		...
		if(Olduser!=null)
		{
			...
			if(updateUser!=null)
			{
				...
				session.setAttribute("msg", "Profile Updated Sucessfully..");
			}
